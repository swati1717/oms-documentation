---
description: >-
  Learn how HotWax Commerce leverages SuiteScript for integration  with
  NetSuite, using JavaScript-based customization, scheduled scripts, and  data
  transformation.
---
...
<table data-view="cards"><thead><tr><th></th><th data-type="content-ref"></th></tr></thead><tbody><tr><td>Task Module</td><td><a href="n-file-module.md">n-file-module.md</a></td></tr><tr><td>Record Module</td><td><a href="n-record-module.md">n-record-module.md</a></td></tr><tr><td>Search Module</td><td><a href="n-search-module.md">n-search-module.md</a></td></tr><tr><td>File Module</td><td><a href="n-file-module.md">n-file-module.md</a></td></tr></tbody></table>
